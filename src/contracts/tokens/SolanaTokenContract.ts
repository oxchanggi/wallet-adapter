...
import { createTransferInstruction, getAssociatedTokenAddressSync, getMint, createAssociatedTokenAccountInstruction, getAccount } from "@solana/spl-token";

class TokenSdk {
    private readonly _connection: Connection;
    constructor(_connection: Connection, private readonly tokenAddress: string) {
    ...
    async transfer(from: PublicKey, to: PublicKey, amount: string): Promise<{transaction: VersionedTransaction, blockhash: string, lastValidBlockHeight: number}> {
        try {
            const mintPublicKey = new PublicKey(this.tokenAddress);
